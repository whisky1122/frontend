...
function Sidebar({ isSidebarOpen, toggleSidebar }) {
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed left-0 top-[70px] w-64 h-[calc(100vh-70px)] bg-white border-r border-stone-200 shadow-sm z-40 overflow-y-auto transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isMobile && !isSidebarOpen ? '-translate-x-full' : ''}`}
      >
        <div className='p-6'>
